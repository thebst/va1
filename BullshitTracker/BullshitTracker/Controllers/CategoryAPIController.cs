...
namespace BullshitTracker.Controllers
{
    ...
    */
    ...
    public class CategoryAPIController : ODataController
    {
        private BullshitTrackerEntities db = new BullshitTrackerEntities();

        // GET odata/CategoryAPI
        [Queryable]
        public IQueryable<Category> GetCategoryAPI()
        {
            return db.Categories;
        }

        // GET odata/CategoryAPI(5)
        [Queryable]
        ...
        // GET odata/CategoryAPI(5)/ExceptionTransactions
        [Queryable]
        ...
        // GET odata/CategoryAPI(5)/Vendors
        [Queryable]
        ...
        // GET odata/CategoryAPI(5)/PurchasesByCategories
        [Queryable]
        ...
        // GET odata/CategoryAPI(5)/Budget1
        [Queryable]
